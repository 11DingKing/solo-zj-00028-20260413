...
class CustomPageNumberPagination(pagination.PageNumberPagination):
    ...
    def generate_response(self, query_set, serializer, request: Request, total=None, context=None) -> Response:
        try:
        ...
        if context:
            serialized_page = serializer(page_data, many=True, context=context)
        else:
